...
function Navbar() {
    return <>
        <div className="w-[100%] h-[44px]  bg-[#161617CC] backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-80 flex justify-between md:justify-center gap-[2.75vw] sticky items-center top-0 " >
            ...
            <div className='w-[140px] md:w-[auto] mr-2  md:mr-0 nav_content gap-[2.75vw] flex'>
                ...
                <button className='ml-4 pt-[2px] inline md:hidden' id="globalnav-menutrigger-button" aria-controls="globalnav-list" aria-label="Menu" data-topnav-menu-label-open="Menu" data-topnav-menu-label-close="Close" data-topnav-flyout-trigger-compact="menu" class="globalnav-menutrigger-button">
                    <svg width="18" height="18" viewBox="0 0 18 18">
                        <polyline id="globalnav-menutrigger-bread-bottom" fill="#FFFFFF" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" points="2 12, 16 12" class="globalnav-menutrigger-bread globalnav-menutrigger-bread-bottom">
